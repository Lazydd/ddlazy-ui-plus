...
<template>
	<label :class="['dd-radio-wrapper', { 'dd-radio-wrapper-disabled': disabled }]" @click.stop="radioClick">
		<span :class="['dd-radio', { 'dd-radio-checked': modelChecked, 'dd-radio-disabled': disabled }]">
