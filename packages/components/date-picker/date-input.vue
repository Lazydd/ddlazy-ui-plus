...
const { formatShow, formatValue, disabled, placeholder, allowClear, suffix = true, showIcon = true, readonly = false, showTime = false } = defineProps<{
...
<template>
	<div class="dd-picker-input" :disabled>
		<input ref="datePickerInput" autocomplete="off" :placeholder="placeholder ?? '请选择日期'" :value="formatShow"
			:disabled :readonly :size="showTime ? 21 : 10" />
		<span class="dd-picker-suffix">
			<slot name="suffixIcon">
				<span v-if="showIcon" role="img" aria-label="calendar" class="anticon anticon-calendar">
		...
		<span class="dd-picker-clear" role="button" @click.stop="clearClick"
